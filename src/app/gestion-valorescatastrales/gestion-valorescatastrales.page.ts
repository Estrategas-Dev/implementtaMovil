...
@Component({
  selector: 'app-gestion-valorescatastrales',
  templateUrl: './gestion-valorescatastrales.page.html',
  styleUrls: ['./gestion-valorescatastrales.page.scss'],
})
export class GestionValorescatastralesPage implements OnInit {
  ...
  async getInfoAccount() {
    ...
    this.supConstruccion = this.infoAccount[0].SupConstruccionH;
    this.supTerreno = this.infoAccount[0].SupTerrenoH;
    this.valConstruccion = this.infoAccount[0].ValorConstruccionH;
    this.valTerreno = this.infoAccount[0].ValorTerrenoH;
    this.valCatastral = this.infoAccount[0].ValorCatastralH;
    this.tipoServicio = this.infoAccount[0].tipoServicio;
