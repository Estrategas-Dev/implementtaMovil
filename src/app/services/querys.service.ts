...
export class QuerysService {
  ...
  forma_pago TEXT, observaciones TEXT, id_tarea INTEGER, latitud TEXT, longitud TEXT, tipoServicio TEXT, clave_catastral TEXT, rutaArcgis TEXT, numMedidor TEXT, gestionada INTEGER  NOT NULL DEFAULT 0)`;
    ...
    let tableCarta = `CREATE TABLE IF NOT EXISTS gestionCartaInvitacion (id INTEGER PRIMARY KEY AUTOINCREMENT,account TEXT,idTarea INTEGER,idaspuser TEXT,fechaCaptura TEXT,latitud TEXT, longitud TEXT,idTipoServicio INTEGER, cargado INTEGER NOT NULL DEFAULT 0  )`;
